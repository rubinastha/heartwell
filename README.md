...
Early-stage MVP / prototype, built to validate the core concept with real users before further development. See [`prd-cardioclear.md`](./prd-cardioclear.md) for the full product requirements and success metrics, and [`project-brief.md`](./project-brief.md) for the problem background and research behind it.
